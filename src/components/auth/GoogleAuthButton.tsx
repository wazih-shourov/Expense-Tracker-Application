...
const GoogleAuthButton: React.FC<GoogleAuthButtonProps> = ({ 
  ...
  return (
    <Button
      ...
      disabled={loading}
      variant="outline"
      className="w-full py-3 px-4 bg-white hover:bg-gray-50 text-gray-700 font-medium rounded-lg border border-gray-300 shadow-sm hover:shadow transition-all duration-200 flex items-center justify-center gap-3"
    >
